...
export const STRINGS = {
  en: {
    ...
    landing: {
      title: "Omni, the chat agent that answers your website visitors",
      description: "Omni answers your visitors' questions day and night and collects their contact details. Installed on your site with one line of code, from €600 per product.",
      badge: "AI agent for your website",
      h1: "Your visitors have questions <em>at&nbsp;10&nbsp;pm</em>. Omni answers them.",
      ...
      video: "/assets/omni-demo-en.mp4",
      poster: "/assets/omni-demo-en-poster.jpg",
      videoLabel: "Demo: a visitor asks a question in the evening and Omni takes their call-back request",
      clientEyebrow: "Who uses Omni",
      clientTitle: "ALYOR, wealth advice for the self-employed",
      clientBody: "On alyor.fr, Omni is on every page. On mobile, it takes the place of the call button outside opening hours, so evening and weekend visitors always have someone to talk to.",
      howEyebrow: "How it works",
      howTitle: "Live in a few days, <em>not a few months</em>",
      steps: [
        ["One line of code", "Paste one tag on your site and Omni appears on every page, on desktop and mobile."],
    ...
    articles: {
      ...
      insightKicker: "Omni calculation",
      published: "Published",
      updated: "Updated",
      ...
      ctaTitle: "Omni answers your visitors, even out of hours.",
  ...
  fr: {
    ...
    footerArticles: "Articles",
    landing: {
      title: "Omni, l’agent de chat qui répond à vos visiteurs",
      description: "Omni répond aux questions de vos visiteurs jour et nuit et recueille leurs coordonnées. Installé sur votre site en une ligne de code, à partir de 600 € par produit.",
      badge: "Agent IA pour votre site",
      h1: "Vos visiteurs ont des questions <em>à&nbsp;22h</em>. Omni y répond.",
      ...
      video: "/assets/omni-demo-fr.mp4",
      poster: "/assets/omni-demo-fr-poster.jpg",
      videoLabel: "Démonstration : un visiteur pose une question le soir et Omni recueille sa demande de rappel",
      clientEyebrow: "Ils utilisent Omni",
      clientTitle: "ALYOR, conseil patrimonial pour les indépendants",
      clientBody: "Sur alyor.fr, Omni est présent sur chaque page. Sur mobile, il prend la place du bouton d’appel en dehors des heures d’ouverture&nbsp;: les visiteurs du soir et du week-end ont toujours quelqu’un à qui parler.",
      howEyebrow: "Fonctionnement",
      howTitle: "En place en quelques jours, <em>pas en quelques mois</em>",
      steps: [
        ["Une ligne de code", "Une balise à coller sur votre site, et Omni s’affiche sur toutes les pages, sur ordinateur comme sur mobile."],
    ...
    articles: {
      ...
      ctaTitle: "Omni répond à vos visiteurs, même hors horaires.",
